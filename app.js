// Last auto-updated: 21 Jul 2026 09:00 WIB
/* ============================================
...
const CONCERTS = [
...

  {
    ...
    priceRange: 'Rp 1.050.000 – Rp 5.500.000',
    priceMin: 1050000, priceMax: 5500000,
    ticketCategories: [
      { name: 'Nightrain Fan Club Presale (2 Jul)', price: 'Rp 1.050.000 – Rp 5.500.000' },
      { name: 'BALE by BTN Presale (16 Jul)', price: 'Rp 1.050.000 – Rp 5.500.000' },
      { name: 'General Sale (30 Jul)', price: 'Rp 1.050.000 – Rp 5.500.000' },
    ],
    confirmStatus: 'confirmed', hot: true,
...

  {
    ...
    genre: 'rock', emoji: '🎸',
    dates: ["3 Februari 2026"],
    rawDate: new Date('2026-02-03'),
    time: '19:30 WIB',
    venue: 'Beach City International Stadium',
    city: 'Ancol, Jakarta Utara',
    promotor: 'Rajawali Indonesia',
    ticketPlatform: 'FASTicket.id',
    ticketUrl: 'https://bryanadamsjakarta.com',
    priceRange: 'Rp 1.150.000 – Rp 3.750.000',
    priceMin: 1150000, priceMax: 3750000,
    ticketCategories: [
      { name: 'CAT 3 A/B/C (Seating)', price: 'Rp 1.150.000' },
      { name: 'CAT 1 (Festival)', price: 'Rp 1.500.000' },
      { name: 'CAT 2 (Festival)', price: 'Rp 2.750.000' },
      { name: 'VIP (Seating)', price: 'Rp 3.750.000' },
    ],
    confirmStatus: 'past', hot: false,
    description: 'Bryan Adams membawa Roll with the Punches Tour ke Jakarta di Beach City International Stadium. Ari Lasso hadir sebagai special guest. Harga belum termasuk pajak 10% dan admin 5%.',
    sources: ["bryanadamsjakarta.com", "idntimes.com", "fasticket.id"],
  },
...

  {
    ...
    priceRange: 'Rp 910.000 – Rp 5.000.000',
    priceMin: 910000, priceMax: 5000000,
    ticketCategories: [
      { name: 'CAT 4 (Numbered Seating)', price: 'Rp 910.000' },
      { name: 'CAT 3 (Numbered Seating)', price: 'Rp 1.320.000' },
      { name: 'CAT 2 (Numbered Seating)', price: 'Rp 1.630.000' },
      { name: 'GA (Standing w/ Queue Number)', price: 'Rp 1.950.000' },
      { name: 'CAT 1 (Numbered Seating)', price: 'Rp 2.140.000' },
      { name: 'GA VIP No.1 Obsession Package (Standing)', price: 'Rp 3.950.000' },
      { name: 'CAT 1 VIP No.1 Obsession Seat Package', price: 'Rp 4.140.000' },
      { name: 'VIP Box No.1 Obsession Seat Package', price: 'Rp 5.000.000' },
    ],
    confirmStatus: 'confirmed', hot: true,
    description: '5 Seconds of Summer kembali ke Indonesia dalam EVERYONE\'S A STAR! World Tour di Indonesia Arena GBK, 14 November 2026.',
...

  {
    ...
    tour: 'The Sounds Project 2026: Beyond Memories',
    genre: 'indie', emoji: '🎪',
    dates: ["7 Agustus 2026", "8 Agustus 2026", "9 Agustus 2026"],
    rawDate: new Date('2026-08-07'),
    time: 'TBA',
    venue: 'Ecovention & Ecopark Ancol',
    city: 'Ancol, Jakarta Utara',
    promotor: 'TBA',
    ticketPlatform: 'TBA',
    ...
    priceMin: 0, priceMax: 0,
    ticketCategories: [{ name: 'Semua kategori', price: 'Belum diumumkan' }],
    lineup: ['Neck Deep', 'JET', 'Nusantara Beat', 'Pamungkas', 'Rizky Febian', 'JUICY LUICY', 'For Revenge', 'Barasuara', 'Lomba Sihir', 'Adrian Khalif', 'Perunggu', 'The Panturas', 'Kangen Band'],
    confirmStatus: 'past', hot: false,
    description: 'The Sounds Project Vol. 9: Beyond Memories berlangsung 3 hari di Ecovention & Ecopark Ancol. Lineup internasional: Neck Deep, JET, Nusantara Beat, bersama deretan artis lokal terbaik Indonesia.',
    sources: ["thesoundsproject.com", "idntimes.com", "frontstagefestivals.com"],
  },

  {
    ...
    venue: 'Indonesia Arena, GBK',
    city: 'Senayan, Jakarta Pusat',
    promotor: 'Live Nation & TEM Presents',
    ticketPlatform: 'Tiket.com / babymonsterinjakarta2026.com',
    ticketUrl: 'https://babymonsterinjakarta2026.com',
    priceRange: 'Belum diumumkan',
    priceMin: 0, priceMax: 0,
    ticketCategories: [{ name: 'Semua kategori (via Tiket.com)', price: 'Cek babymonsterinjakarta2026.com' }],
    confirmStatus: 'confirmed', hot: true,
    description: 'BABYMONSTER (YG Entertainment) menggelar 2026-27 WORLD TOUR [춤 (CHOOM)] di Indonesia Arena GBK pada 17 Oktober 2026. Show starts 6:30 PM. Tiket via babymonsterinjakarta2026.com dan Tiket.com. Dipromosikan oleh Live Nation dan TEM Presents.',
    sources: ["babymonsterinjakarta2026.com", "weverse.io", "ygfamily.com"],
  ...
  {
    id: 'lee-hi-jakarta-2026',
    artist: 'Lee Hi',
    tour: '808 HI Recordings World Tour 2026',
    genre: 'kpop', emoji: '🎵',
    dates: ["9 Agustus 2026"],
    rawDate: new Date('2026-08-09'),
    time: 'TBA',
    venue: 'Bengkel Space',
    city: 'Senayan, Jakarta Selatan',
    promotor: 'The Great Indonesia Experiment / Row One Asia',
    ticketPlatform: 'Row One Asia',
    ticketUrl: 'https://www.rowone.asia/26id-leehi',
    priceRange: 'Rp 1.300.000 – Rp 5.000.000',
    priceMin: 1300000, priceMax: 5000000,
    ticketCategories: [
  ...
  {
    id: 'ikon-jakarta-2026',
    artist: 'iKON',
    tour: "iKON 'FOUREVER' World Tour 2026",
    genre: 'kpop', emoji: '🔥',
    dates: ["21 Agustus 2026"],
    rawDate: new Date('2026-08-21'),
    time: 'TBA',
    venue: 'Istora Senayan',
    ...
    description: "iKON menggelar konser 'FOUREVER' World Tour 2026 di Istora Senayan Jakarta.",
    sources: ["idntimes.com"],
  },
  {
    id: 'jannabi-jakarta-2026',
    artist: 'JANNABI',
    tour: 'JANNABI 1st Asia Tour: Sweat & Stardust',
    genre: 'indie', emoji: '🌟',
    dates: ["23 Agustus 2026"],
    rawDate: new Date('2026-08-23'),
    time: 'TBA',
    venue: 'JIExpo Convention Center',
    city: 'Jakarta Pusat',
    ...
    confirmStatus: 'confirmed', hot: false,
    description: 'JANNABI menggelar tur Asia perdana bertajuk Sweat & Stardust di Jakarta. Band indie Korea Selatan ini dikenal lewat hits seperti A Thought on an Autumn Night.',
    sources: ["idntimes.com", "x.com/flabbergastProd"],
  },
  {
    id: 'park-ji-hoon-jakarta-2026',
    artist: 'Park Ji Hoon',
    tour: "Park Ji Hoon Fan Concert Asia Tour [RE:FLECT]",
    genre: 'kpop', emoji: '💫',
    dates: ["29 Agustus 2026"],
    rawDate: new Date('2026-08-29'),
    time: 'TBA',
    venue: 'SPIKE AIR DOME - PIK 2',
    city: 'PIK 2, Jakarta',
    promotor: 'TBA',
    ticketPlatform: 'TBA',
    ticketUrl: 'https://www.list-concert-tour.web.id',
    ...
    confirmStatus: 'confirmed', hot: false,
    description: 'Park Ji Hoon menggelar fan concert Asia Tour RE:FLECT di SPIKE AIR DOME PIK 2.',
    sources: ["idntimes.com"],
  },
  {
    id: 'u-know-jakarta-2026',
    artist: 'U-KNOW (TVXQ)',
    tour: 'U-KNOW PROJECT 26 : SCENE#1',
    genre: 'kpop', emoji: '🎤',
    dates: ["13 September 2026"],
    rawDate: new Date('2026-09-13'),
    time: 'TBA',
    ...
    confirmStatus: 'confirmed', hot: false,
    description: 'U-KNOW dari TVXQ menggelar solo project bertajuk PROJECT 26 : SCENE#1 di Tennis Indoor Senayan.',
    sources: ["idntimes.com"],
  },
  {
    id: 'mamamoo-jakarta-2026',
    artist: 'MAMAMOO',
    tour: 'MAMAMOO 2026 World Tour [4WARD]',
    genre: 'kpop', emoji: '🌈',
    dates: ["19 September 2026"],
    rawDate: new Date('2026-09-19'),
    time: 'TBA',
    venue: 'NICE PIK 2',
    city: 'PIK 2, Jakarta',
    promotor: 'TBA',
    ...
    confirmStatus: 'confirmed', hot: false,
    description: 'MAMAMOO menggelar world tour 4WARD di NICE PIK 2 Jakarta. Grup vokal KPop generasi ketiga ini dikenal dengan kemampuan vokal kuat dan panggung energik.',
    sources: ["idntimes.com"],
  },
  {
    id: 'tiffany-young-jakarta-2026',
    artist: 'Tiffany Young',
    tour: 'Edge of Calm Tour',
    genre: 'kpop', emoji: '💎',
    dates: ["19 September 2026"],
    rawDate: new Date('2026-09-19'),
    time: 'TBA',
    ...
    confirmStatus: 'confirmed', hot: false,
    description: 'Tiffany Young (ex-SNSD/Girls Generation) menggelar konser solo Edge of Calm Tour di JIEXPO Theatre Jakarta.',
    sources: ["idntimes.com"],
  },
  {
    ...
    confirmStatus: 'confirmed', hot: true,
    description: 'NCT 127 kembali ke Jakarta dengan tur ke-5 NEO CITY: THE REDLINE di Indonesia Arena GBK.',
    sources: ["idntimes.com"],
  },
  {
    id: 'the-rose-jakarta-2026',
    artist: 'The Rose',
    tour: 'The Rose ROSETOPIA World Tour',
    genre: 'kpop', emoji: '🌹',
    dates: ["23 Oktober 2026"],
    rawDate: new Date('2026-10-23'),
    time: 'TBA',
    ...
    confirmStatus: 'confirmed', hot: false,
    description: 'The Rose menggelar ROSETOPIA World Tour di The Kasablanka Jakarta. Band indie rock Korea Selatan yang populer lewat lagu She Is In The Rain.',
    sources: ["idntimes.com"],
  },
  {
    id: 'lany-jakarta-2026',
    artist: 'LANY',
    tour: 'LANY: soft World Tour',
    genre: 'pop', emoji: '🎶',
    dates: ["29 Oktober 2026", "30 Oktober 2026"],
    rawDate: new Date('2026-10-29'),
    time: 'TBA',
    venue: 'Indonesia Arena',
    city: 'GBK Senayan, Jakarta',
    promotor: 'TEM Presents',
    ticketPlatform: 'Tiket.com',
    ticketUrl: 'https://thisislany.com/pages/tour',
    priceRange: 'Rp 900.000 – Rp 7.000.000',
    priceMin: 900000, priceMax: 7000000,
    ticketCategories: [
      { name: 'Semua kategori', price: 'Rp 900.000 – Rp 7.000.000' },
    ],
    confirmStatus: 'confirmed', hot: true,
    description: 'LANY kembali ke Jakarta untuk soft World Tour 2026 selama 2 malam di Indonesia Arena. Tur ini mencakup 45 kota di seluruh dunia.',
    sources: ["inilah.com", "idntimes.com"],
  },
  {
    id: 'simple-plan-jakarta-2026',
    artist: 'Simple Plan',
    tour: 'The Bigger Than You Think! Tour',
    genre: 'rock', emoji: '🎸',
    dates: ["27 November 2026"],
    rawDate: new Date('2026-11-27'),
    time: 'TBA',
    venue: 'Tennis Indoor Senayan',
    city: 'Senayan, Jakarta',
    promotor: 'TBA',
    ...
    confirmStatus: 'confirmed', hot: false,
    description: 'Simple Plan menggelar The Bigger Than You Think! Tour di Tennis Indoor Senayan Jakarta. Band pop punk Kanada ini dikenal lewat hits Welcome to My Life dan Perfect.',
    sources: ["idntimes.com"],
  },
  {
    id: 'boynextdoor-jakarta-2026',
    artist: 'BOYNEXTDOOR',
    tour: "BOYNEXTDOOR TOUR 'KNOCK ON Vol.2'",
    genre: 'kpop', emoji: '🚪',
    dates: ["5 Desember 2026"],
    rawDate: new Date('2026-12-05'),
    time: 'TBA',
    venue: 'ICE BSD City Hall 5-6',
    city: 'Tangerang',
    promotor: 'TBA',
    ticketPlatform: 'Tiket.com',
    ticketUrl: 'https://bndinjakarta.com/',
    priceRange: 'Rp 2.100.000 – Rp 3.900.000',
    priceMin: 2100000, priceMax: 3900000,
    ticketCategories: [
      { name: 'Semua kategori', price: 'Rp 2.100.000 – Rp 3.900.000' },
    ],
    confirmStatus: 'confirmed', hot: false,
    description: "BOYNEXTDOOR menggelar tur dunia KNOCK ON Vol.2 di ICE BSD Hall 5-6 Tangerang. Sebelum tur, mereka merilis album studio pertama 'HOME'.",
    sources: ["inilah.com", "bndinjakarta.com"],
  }
